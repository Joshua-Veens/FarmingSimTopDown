...
void tractor::updateCollider(){
    if(savedRotation == 0){
        if(active_size == big){
            ...
            blokje.jump(sf::Vector2f(position.x - 16, position.y-60));
            blokje.setSize(sf::Vector2f(30, 5));
        ...
        if(active_size == big){
            ...
            blokje.jump(sf::Vector2f(position.x - 59, position.y -14));
            blokje.setSize(sf::Vector2f(5, 30));
